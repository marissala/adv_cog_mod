...
gridExtra::grid.arrange(
  plot_actual_predicted(PVL_t.a, PVL_i.a),
  plot_actual_predicted(PVL_t.w, PVL_i.w),
  plot_actual_predicted(PVL_t.A, PVL_i.A),
  plot_actual_predicted(PVL_t.theta, PVL_i.theta),
  ncol = 2
)

par(mfrow=c(2,1))
plot(density(PVL_t.A))
plot(density(PVL_i.A))
...
par(mfrow=c(2,1))
plot(density(PVL_t.w))
plot(density(PVL_i.w))

par(mfrow=c(2,1))
plot(density(PVL_t.theta))
plot(density(PVL_i.theta))
```
