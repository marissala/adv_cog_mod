...
params <- c("mu_a_rew","mu_a_pun","mu_K","mu_omega_f", "mu_omega_p",
            "lambda_a_rew_ctr","lambda_a_pun_ctr","lambda_K_ctr","lambda_f_ctr", "lambda_p_ctr")
...
plot(density(samples2$BUGSoutput$sims.list$lambda_f_ctr))
plot(density(samples2$BUGSoutput$sims.list$lambda_p_ctr))
...
Save samples
```{r}
save.image(file='hPVL_hORL_model_samples.RData')
load("hPVL_hORL__model_samples.RData")
```
