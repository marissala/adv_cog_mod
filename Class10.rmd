...
par(mfrow=c(2,1))
plot(density(ORL_t.a_rew))
plot(density(ORL_i.a_rew))

par(mfrow=c(2,1))
plot(density(ORL_t.a_pun))
plot(density(ORL_i.a_pun))

par(mfrow=c(2,1))
plot(density(ORL_t.beta_f))
plot(density(ORL_i.beta_f))

par(mfrow=c(2,1))
plot(density(ORL_t.beta_p))
plot(density(ORL_i.beta_p))

par(mfrow=c(2,1))
plot(density(ORL_t.K))
plot(density(ORL_i.K))

par(mfrow=c(2,1))
plot(density(ORL_t.theta))
plot(density(ORL_i.theta))
```
